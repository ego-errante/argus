...
A judge's fast path — what to read, the one thing that proves the thesis, and how to reproduce it. The full system design lives in the **[hosted architecture document](https://argus-architecture.foolt757.workers.dev/)** (the separately-judged deliverable).
...
- **[Architecture document](https://argus-architecture.foolt757.workers.dev/)** — the hosted system design (the separately-judged deliverable; the big-picture *why* and *shape*).
